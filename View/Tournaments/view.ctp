...
<iframe src="http://<?php echo $challonge_tournament->subdomain; ?>.challonge.com/<?php echo $challonge_tournament->url; ?>/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe>
	<dl>
